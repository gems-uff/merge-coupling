...
public class Git {
    ...
    public static List<String> getChangedFiles(String repository, String sha1) {
        ...
        List<String> result = new ArrayList<String>();
//"diff-tree"
        String[] command = {"git", "diff", "--no-commit-id", "--name-only", "-r", sha1};
    ...
    public static String getFirstHash(String repository) {

        String command = "git rev-list --max-parents=0 HEAD";
        CMDOutput cmdOutput = CMD.cmd(repository, command);
        if (cmdOutput.getErrors().isEmpty()) {
            return cmdOutput.getOutput().get(0);
        } else {
    ...
    public static String getParents2(String repository, String SHAMerge) {

        String command = "git log --pretty=%P -n 1 " + SHAMerge ;
        CMDOutput cmdOutput = CMD.cmd(repository, command);
        if (cmdOutput.getErrors().isEmpty()) {
            return cmdOutput.getOutput().get(0);
        } else {
...
//        String command = "git rev-list --parents -n 1 " + revision;
    ...
    public static List<String> getCommits(String repositoryPath, String SHAMergeBase, String SHAParent) {
        String command = "git rev-list " + SHAMergeBase + ".." + SHAParent;
    ...
    public static List<String> getHashs(String repositoryPath, String hashBegin, String hashEnd ) {
